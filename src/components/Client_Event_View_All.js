            ...
            <tbody>

                {
                    eventPosts.filter((event_post) => {
                        ...
                        if (searchValue == ""){
                            return event_post.event_status == "Upcoming Event"
                        }
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <Link className="btn btn-secondary" to={`/client_event_edit/${event_post.id}`} >Edit</Link> {" "}
                                <Link className="btn btn-secondary" to="/client_event_view_all" onClick={() => deleteEventPost(event_post.id)} >Delete</Link> {" "}
                                <StripeCheckout 
...
export default Client_Event_View_All